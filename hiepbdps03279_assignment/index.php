...
<p style="margin-left:90px">Tài khoản: admin Mật khẩu: admin</p>
		<form method="post" action="" id="loginForm">
			...
			<input type="password" class="text" name="txtPass" id="txtPass" class="form-text" />
					<input type="submit" name="btnSubmit" id="btnSubmit" value="Đăng nhập quản trị" class="form-submit" />
		</form>
        </br>
        <a href="customer.php" style="text-align:center;font-size:18px;text-decoration:none;color:#9F0;margin-left:30px">Sử dụng trang web dưới dạng khách hàng</a>
</div>
